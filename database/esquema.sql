-- =====================================================================
--  RENT SMART · Esquema de la base de datos (MySQL 8 / MariaDB 10.4+)
--  Etapa 2 — Desarrollo base del proyecto (Web)
--
--  Convención: los nombres en la base van en snake_case; la capa de
--  repositorios los traduce a camelCase con alias en cada SELECT.
-- =====================================================================
...
-- ---------------------------------------------------------------------
-- CLIENTES · datos del arrendatario
-- ---------------------------------------------------------------------

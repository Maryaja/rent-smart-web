...
/**
 * La tabla `clientes` no guarda usuario_id (la relación va en sentido
 * contrario: usuarios.cliente_id), así que se resuelve con un LEFT JOIN.
 */
const SELECT_BASE = `
  SELECT
    c.id,
...
/** Lista de clientes con el resumen de su facturación (para el back-office). */
